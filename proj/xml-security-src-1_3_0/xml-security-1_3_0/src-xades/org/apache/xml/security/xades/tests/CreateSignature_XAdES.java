 ...
 */
public class CreateSignature_XAdES {

   /** {@link org.apache.commons.logging} logging facility */
    static org.apache.commons.logging.Log log = 
        org.apache.commons.logging.LogFactory.getLog(CreateSignature_XAdES.class.getName());
...
//   	SigningTime
        ...
        random.nextBytes(r);
     	...
     	hashdatainfo.setUriAttr(tmpElemId);      	
      	...
      	encapsulatedtimestamp.addBase64Extension(cert.getEncoded(), "EncapsulatedPKIData");
      	...
      	encapsulatedtimelstamp.addBase64Extension(cert.getEncoded(), "EncapsulatedPKIData");
